...
This distribution currently carries 28 downstream patches across 13 main feature and stability areas:
...
5. Kimi Code and AntiGravity CLI executor support plus refreshed stable CLI pins for Claude Code, Codex, Gemini, Qwen, Copilot, and OpenCode, with Codex `npx` cache isolation for shared-cache workspaces.
